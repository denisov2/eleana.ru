...
<div id="carousel3" class="carousel slide carousel-products" data-ride="carousel">
    <!-- Wrapper for slides -->
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <div class="row">
                <?php
                $products = Product::find()->limit(3)->offset(6)->all();;
        ...
        <div class="item">
            <div class="row">
                <?php
                $products = Product::find()->limit(3)->offset(9)->all();
                foreach ($products as $key => $product) {
                    $images = $product->getImages();
                    $image_html = isset($images[0]) ? '<img src="' . $images[0]->getUrl('174x') . '">' : '<img src="/img/tovar2.jpg">';
                    $classes = $key % 3 == 0 ? "col-md-4" : "col-md-4 hidden-xs hidden-sm";
