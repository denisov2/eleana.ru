...
$(function(){
	...
	var productUrl = "http://996934.uy228250.web.hosting-test.net/constructor/json/product.json";
	...
	$(".preview_btn").on("click", function(){
		...
		$("#previewModal .modal-title").text("Просмотр");
	...
	$(".export_btn").on("click", function(){
		...
		$("#previewModal .modal-title").text("Сохранить");
